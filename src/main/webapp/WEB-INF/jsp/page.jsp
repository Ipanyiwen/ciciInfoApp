                ...
                <span class="usercc" id="userinfo">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="/logout?page=page">退出登录</a></li>
                        </ul>
                    </div>
                </span>
            </c:otherwise>
        ...
        <div class="content">
            ...
            <script>
                ...
                $(function () {
                    ...
                    createTable(1, 8); //第一次调用(加载第一页数据)
                    callBackPagination(1, 8, total); //参数一：当前页 参数二：页大小  参数三：数据总条数（不需要传递总页数）
                });
