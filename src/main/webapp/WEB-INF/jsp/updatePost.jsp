...
<section class="container-single">
    <div class="content-wrap">
        <div class="singleh">
            <div class="content">
                <h1 class="article-title">编辑文章</h1>
                <h1 class="article-title">
                    <input type="text" id="title" class="form-control" value="${post.postTitle}" placeholder="在此处撰写标题"/>
                </h1>
                ...
                <article>
                    ...
                    <textarea style="display: none;" id="content">${post.postContent}</textarea>
                </article>
                ...
                <div class="comments">
                    ...
                    <textarea placeholder="对于文章的简单描述" class="input-block-level comt-area" name="txaArticle"
                              ...
                              tabindex="1">${post.postExcerpt}</textarea>
                ...
                <div class="comments">
                    ...
                    <form id="picform" name="picform">
                        <div class="file-loading">
                            ...
                            <input id="displaypic" name="picupload" type="hidden" value="${post.postPic}">
                        </div>
                    </form>
                    ...
                    <script>
                        $(document).on('ready', function () {
                            $("#picupload").fileinput({
                                ...
                                initialPreview: [
                                    "<img src='${post.postPic}' class='file-preview-image'>"
                                ],
                    ...
                    <div class="title" style="margin-bottom:30px; margin-top:20px;">
                        ...
                        <script>
                            ...
                            $(function () {
                                ...
                                // });
                                var i = 0;
                                <c:forEach var="item" items="${post.tags}">
                                    $("#tags").tagsinput('add', '${item.name}');
                                </c:forEach>
                                ...
                                $("#tags").on('beforeItemAdd', function(event){
                                    ...
                                    if(oldtag.indexOf(tag) == -1){
                                        addtags[addtags.length] = tag;
                                    }else {
                                        var index = removetags.indexOf(tag);
                                        if(index != -1)
                                ...
                                $("#tags").on('beforeItemRemove', function(event) {
                                    ...
                                    // Do some processing here
                                    if(oldtag.indexOf(tag) == -1){
                                        var index = addtags.indexOf(tag);
                                        if(index != -1){
                                            addtags.splice(index, 1);
                                        }
                                    }else {

                                        removetags[removetags.length] = tag;
                                    }
                                });
                            });
                        </script>
                ...
                <div class="comments">
                    <button class="btn btn-success" id="postsubmit">更新</button>
                    &nbsp;
                ...
                <script>
                    $(function () {
                        ...
                        $("#postsubmit").click(function () {
                            ...
                            var type = $("#type").val();
                            var oldtype = ${post.term.termId};
                            var postContent = editor.txt.html();
                            var postid = ${param.pid};
                            var pic = "${post.postPic}";
                            ...
                            mydata.append('addtags', addtags);
                            mydata.append('removetags', removetags);
                            mydata.append('oldtype', oldtype);
                        ...
                        $("#posttype").find("option[value='${post.postType}']").attr('selected', true);
                    });
    ...
    $(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                terms[num].forEach(function (term) {
                    msg += '<option value="' + term["termId"] + '">' + term["name"] + '</optino>';
                });
                $("#type").append(msg);
                $("#type").find("option[value='${post.term.termId}']").attr('selected', true);
            }
        });
